...
module.exports = __toCommonJS(browser_action_exports);
...
var injectBrowserAction = () => {
  ...
  function mainWorldScript() {
    ...
    class BrowserActionElement extends HTMLButtonElement {
      constructor() {
        super();
        __publicField(this, "updateId");
        __publicField(this, "badge");
        __publicField(this, "pendingIcon");
    ...
    class BrowserActionListElement extends HTMLElement {
      constructor() {
        super();
        __publicField(this, "observing", false);
        __publicField(this, "fetchState", async () => {
          try {
