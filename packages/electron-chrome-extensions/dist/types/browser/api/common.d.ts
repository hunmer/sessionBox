...
export declare const validateExtensionUrl: (url: string, extension: Electron.Extension) => string;
export declare const resolveExtensionPath: (extension: Electron.Extension, uri: string, requestPath?: string) => string | undefined;
...
export declare const getAllWindows: () => (Electron.BaseWindow | Electron.BrowserWindow)[];
