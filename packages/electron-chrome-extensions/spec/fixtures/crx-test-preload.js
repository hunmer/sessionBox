...
// spec/fixtures/crx-test-preload.ts
...
// spec/fixtures/crx-test-preload.ts
var apiName = "electronTest";
var api = {
  sendIpc(channel, ...args) {
    return import_electron2.ipcRenderer.send(channel, ...args);
  },
  invokeIpc(channel, ...args) {
    return import_electron2.ipcRenderer.invoke(channel, ...args);
  }
};
try {
