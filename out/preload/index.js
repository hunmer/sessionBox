...
const api = {
  ...
  settings: {
    ...
    getTabImplementation: () => electron.ipcRenderer.invoke("settings:getTabImplementation"),
    setTabImplementation: (implementation) => electron.ipcRenderer.invoke("settings:setTabImplementation", implementation),
