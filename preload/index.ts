...
const api = {
  ...
  download: {
    ...
    pauseSystem: (gid: string): Promise<void> => ipcRenderer.invoke('download:pauseSystem', gid),
    resumeSystem: (gid: string): Promise<void> => ipcRenderer.invoke('download:resumeSystem', gid),
